...
#include "robot_arm_interfaces/action/robot_arm_task.hpp"
...
public:
    ...
    : Node("task_server", options)
  {
    ...
    action_server_ = rclcpp_action::create_server<robot_arm_interfaces::action::RobotArmTask>(
...
private:
  rclcpp_action::Server<robot_arm_interfaces::action::RobotArmTask>::SharedPtr action_server_;

  rclcpp_action::GoalResponse goalCallback(
      const rclcpp_action::GoalUUID& uuid,
      std::shared_ptr<const robot_arm_interfaces::action::RobotArmTask::Goal> goal)
  {
  ...
  rclcpp_action::CancelResponse cancelCallback(
      const std::shared_ptr<rclcpp_action::ServerGoalHandle<robot_arm_interfaces::action::RobotArmTask>> goal_handle)
  {
    (void)goal_handle;
  ...
  void execute(const std::shared_ptr<rclcpp_action::ServerGoalHandle<robot_arm_interfaces::action::RobotArmTask>> goal_handle)
  {
    RCLCPP_INFO(get_logger(), "Executing goal");
    auto result = std::make_shared<robot_arm_interfaces::action::RobotArmTask::Result>();
